...
/**
 * Defines colors listed in the CSS Color Module Level 3 specification by the
 * W3C. However, 25, 50 and 75 percentile calculations are floored.
 *
 * This class is symbolically compatible to Java's Color. `X11_` is prepended to
 * some extended/X11 colors with conflicting names.
 *
 * @author Brendon
 *
 * @see java.awt.Color
 * @see
 * <a href="https://www.w3.org/TR/2021/REC-css-color-3-20210805">Reference</a>
 */
